...
export class PlayerManagementComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, public store: Store, private snackBarService: SnackBarService) {}

  public ngOnInit(): void {
    this.store.data$.pipe(first((players) => !!players.length)).subscribe((players) => {
